  ...
  describe('upload', () => {
    it('should accept a valid PDF file', async () => {
      prisma.file.create.mockResolvedValue({
        ...
        mimeType: 'application/pdf',
        fileSize: 1024,
        storagePath: '/uploads/123-test.pdf',
        uploadedBy: 'user-1',
      });
    ...
    it('should reject unsupported MIME types', async () => {
      ...
      await expect(service.upload(exeFile as any, 'user-1')).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should reject files exceeding 10MB', async () => {
      ...
      await expect(service.upload(largeFile as any, 'user-1')).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should sanitize filename to prevent path traversal', async () => {
      ...
      await service.upload(traversalFile, 'user-1');
